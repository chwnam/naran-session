...
if ( ! class_exists( 'NSESS_Main_Base' ) ) {
	/**
	 * Class NSESS_Main_Base
	 */
	abstract class NSESS_Main_Base implements NSESS_Module {
		use NSESS_Hook_Impl;
		use NSESS_Submodule_Impl;

		/**
		 * @var NSESS_Main_Base|null
		 */
		private static ?NSESS_Main_Base $instance = null;
		 ...
		 * Get instance method.
		 *
		 * @return NSESS_Main_Base
		 */
		public static function get_instance(): NSESS_Main_Base {
