<?php
/**
 * NSESS: AJAX (admin-ajax.php, or wc-ajax) reg.
 */
...
if ( ! class_exists( 'NSESS_Reg_Ajax' ) ) {
	class NSESS_Reg_Ajax implements NSESS_Reg {
		/** @var string */
		 ...
		 * @param int|null             $priority     Priority number. Defaults to NSESS_PRIORITY.
		 */
		public function __construct(
			...
			$this->priority     = is_null( $priority ) ? nsess()->get_priority() : $priority;
		}
