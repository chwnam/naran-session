...
if ( ! class_exists( 'NSESS_Sciprt_Enqueue' ) ) {
	class NSESS_Sciprt_Enqueue {
		/** @var NSESS_Module|object */
		private $parent;
		 ...
		 * @param string $handle
		 *
		 * @return object|NSESS_Module
		 * @uses NSESS_Template_Impl::enqueue_ejs()
		 */
